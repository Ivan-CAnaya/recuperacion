...
echo Carbon::parse('2020-07-23 14:51')->isoFormat('LLLL'); // 'Tuesday, July 23, 2020 2:51 PM'
echo Carbon::parse('2020-07-23 14:51')->locale('fr_FR')->isoFormat('LLLL'); // 'mardi 23 juillet 2020 14:51'
