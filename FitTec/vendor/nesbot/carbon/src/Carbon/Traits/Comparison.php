...
trait Comparison
{
     ...
     * @example
     * ```
     * var_dump(Carbon::parse('2020-06-02 12:23:45')->is('2020')); // true
     * var_dump(Carbon::parse('2020-06-02 12:23:45')->is('2018')); // false
     * var_dump(Carbon::parse('2020-06-02 12:23:45')->is('2020-06')); // true
     * var_dump(Carbon::parse('2020-06-02 12:23:45')->is('06-02')); // true
     * var_dump(Carbon::parse('2020-06-02 12:23:45')->is('2020-06-02')); // true
     * var_dump(Carbon::parse('2020-06-02 12:23:45')->is('Sunday')); // true
     * var_dump(Carbon::parse('2020-06-02 12:23:45')->is('June')); // true
     * var_dump(Carbon::parse('2020-06-02 12:23:45')->is('12:23')); // true
     * var_dump(Carbon::parse('2020-06-02 12:23:45')->is('12:23:45')); // true
     * var_dump(Carbon::parse('2020-06-02 12:23:45')->is('12:23:00')); // false
     * var_dump(Carbon::parse('2020-06-02 12:23:45')->is('12h')); // true
     * var_dump(Carbon::parse('2020-06-02 15:23:45')->is('3pm')); // true
     * var_dump(Carbon::parse('2020-06-02 15:23:45')->is('3am')); // false
     * ```
     *
